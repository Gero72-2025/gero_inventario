...
<div class="container-fluid mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <!-- Encabezado -->
            <div class="mb-4">
                <h1><?= $heading ?? 'Crear Nueva Bodega' ?></h1>
                <p class="text-muted">Completa el formulario para registrar una nueva bodega en el sistema.</p>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="<?= base_url('bodegas') ?>" method="POST" id="formBodega">
                        <?= csrf_field() ?>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-primary flex-grow-1">
                                <i class="fas fa-save"></i> Crear Bodega
                            </button>
