...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><?= $heading ?? 'Crear Renglón' ?></h4>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('renglones') ?>" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">Crear Renglón</button>
